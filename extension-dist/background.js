...
/* harmony import */ var _scripts_script_manager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/script-manager.js */ "./extension/scripts/script-manager.js");
/* harmony import */ var _scripts_snippet_manager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/snippet-manager.js */ "./extension/scripts/snippet-manager.js");
/* harmony import */ var _scripts_error_debugger_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/error-debugger.js */ "./extension/scripts/error-debugger.js");
/**
...
chrome.runtime.onInstalled.addListener(async ({
  ...
  if (reason === 'install') {
    await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.set)({
      [_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.SETTINGS]: {
      ...
      [_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.SNIPPETS]: [],
      [_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.USER_SCRIPTS]: [],
      [_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERROR_LOG]: [],
      [_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERUDA_ACTIVE_TABS]: {}
    });
  }
...
chrome.runtime.onStartup.addListener(async () => {
  await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.cleanOldErrors)();
  await updateBadge();
});
...
chrome.tabs.onUpdated.addListener(async (tabId, changeInfo, tab) => {
  ...
  const settingsResult = await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.get)(_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.SETTINGS);
  const settings = settingsResult[_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.SETTINGS] || {};
  ...
  if (settings.autoInjectEruda) {
    ...
    const matches = patterns.length === 0 || patterns.some(p => {
      try {
...
async function handleMessage(message, sender) {
  switch (message.type) {
    ...
    case 'GET_SCRIPTS_FOR_URL':
      {
        const scripts = await (0,_scripts_script_manager_js__WEBPACK_IMPORTED_MODULE_1__.getAll)();
        return scripts.filter(s => (0,_scripts_script_manager_js__WEBPACK_IMPORTED_MODULE_1__.shouldRunOn)(s, message.url));
      }
    case 'GET_SNIPPETS_FOR_URL':
      {
        const snippets = await (0,_scripts_snippet_manager_js__WEBPACK_IMPORTED_MODULE_2__.getAll)();
        return snippets.filter(s => (0,_scripts_snippet_manager_js__WEBPACK_IMPORTED_MODULE_2__.matchesUrl)(s, message.url));
      }
    ...
    case 'INSTALL_SCRIPT_FROM_URL':
      {
        const script = await (0,_scripts_script_manager_js__WEBPACK_IMPORTED_MODULE_1__.installFromUrl)(message.url);
        return {
          success: true,
          script
        };
    ...
    case 'CAPTURE_ERROR':
      {
        const entry = await (0,_scripts_error_debugger_js__WEBPACK_IMPORTED_MODULE_3__.appendError)(message.payload);
        await updateBadge();
        return {
          id: entry.id
        };
    ...
    case 'SCRIPT_ERROR':
      {
        const entry = await (0,_scripts_error_debugger_js__WEBPACK_IMPORTED_MODULE_3__.appendError)({
          type: 'script',
          severity: 'error',
    ...
    case 'GM_getValue':
      {
        const storageKey = `gm_${message.scriptId}_${message.key}`;
        const result = await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.get)(storageKey);
        return {
          value: result[storageKey] !== undefined ? result[storageKey] : message.defaultValue
        };
      }
    ...
    case 'GET_QUOTA':
      {
        return (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.checkQuota)();
      }
    default:
      return {
...
async function getErudaState(tabId) {
  const result = await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.get)(_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERUDA_ACTIVE_TABS);
  const activeTabs = result[_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERUDA_ACTIVE_TABS] || {};
  return {
    active: !!activeTabs[tabId]
  };
}
async function setErudaState(tabId, active) {
  ...
  await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.set)({
    [_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERUDA_ACTIVE_TABS]: activeTabs
  });
}
  ...
  if (state.active) {
    try {
      await chrome.scripting.executeScript({
        ...
        func: () => {
          if (typeof eruda !== 'undefined' && eruda._isInit) eruda.hide();
        },
        world: 'MAIN'
      });
...
async function updateBadge() {
  try {
    const result = await (0,_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.get)(_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERROR_LOG);
    const errors = result[_scripts_storage_sync_js__WEBPACK_IMPORTED_MODULE_0__.KEYS.ERROR_LOG] || [];
